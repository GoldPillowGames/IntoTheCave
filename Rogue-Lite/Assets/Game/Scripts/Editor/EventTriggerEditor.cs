...
public class EventTriggerEditor : Editor
{
    ...
    DoorPosition doorPosition = DoorPosition.BOTTOM;
    ...
    public override void OnInspectorGUI()
    {
        ...
        switch (eventType)
        {
            ...
            case EventType.ROOM_DOOR:
                eventTrigger.name = "Room Door (Trigger)";
                doorPosition = (DoorPosition)EditorGUILayout.EnumPopup("Door Position", eventTrigger.doorPosition);
                eventTrigger.tag = "Door";
                eventTrigger.doorPosition = this.doorPosition;
                break;
        }
